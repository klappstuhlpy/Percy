...
ALTER TABLE guild_mod_config RENAME COLUMN raid_mode TO flags;
ALTER TABLE guild_mod_config ALTER COLUMN flags SET DEFAULT 0;
ALTER TABLE guild_mod_config ADD COLUMN audit_log_webhook_url TEXT;
...
UPDATE guild_mod_config SET flags = 3 WHERE flags = 2;

-- Remove all nulls and set them to zero
UPDATE guild_mod_config SET flags = 0 WHERE flags IS NULL;

-- Change the flags to be not null now that there are no null values
ALTER TABLE guild_mod_config ALTER COLUMN flags SET NOT NULL;