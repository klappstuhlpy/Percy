...
class Emoji(commands.Cog):
    ...
    @_commands.command(commands.command, aliases=['emojilist'])
    @_commands.permissions(3, user=['administrator'])
    ...
    @_commands.command(commands.command, name='randomemoji', aliases=['randemoji', 'randemote', 'randomemote'])
    ...
    @_commands.permissions(3, user=['manage_emojis'], bot=['manage_emojis'])
    @commands.guild_only()
