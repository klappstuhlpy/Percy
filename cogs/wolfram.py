...
class Wolfram(commands.Cog):
    ...
    @commands.command(wolfram.command, name='page', aliases=('pa', 'p'),
    ...
    @commands.command(wolfram.command, name='cut', aliases=('c',),
                      description='Requests a drawn image of given query.')
    ...
    @commands.command(wolfram.command, name='short', aliases=('sh', 's'),
