...
class Wolfram(commands.Cog):
    ...
    @_commands.command(commands.hybrid_group, name='wolfram', aliases=('wolf', 'wa'), invoke_without_command=True,
    ...
    @_commands.command(wolfram.command, name='page', aliases=('pa', 'p'),
                          description='Requests a drawn image of given query.')
    ...
    @_commands.command(wolfram.command, name='cut', aliases=('c',),
                          description='Requests a drawn image of given query.')
    ...
    @_commands.command(wolfram.command, name='short', aliases=('sh', 's'),
                       description='Requests an answer to a simple question.')
