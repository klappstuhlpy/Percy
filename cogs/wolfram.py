...
class Wolfram(commands.Cog):
    ...
    @commands_ext.command(wolfram.command, name='page', aliases=('pa', 'p'),
    ...
    @commands_ext.command(wolfram.command, name='cut', aliases=('c',),
                          description='Requests a drawn image of given query.')
    ...
    @commands_ext.command(wolfram.command, name='short', aliases=('sh', 's'),
