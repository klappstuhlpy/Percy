...
class BoardKind(enum.Enum):
    ...
    def __repr__(self) -> discord.PartialEmoji | str:
        if self is self.X:
            return discord.PartialEmoji(name='x_', id=1086732282204782614)
        if self is self.O:
            return discord.PartialEmoji(name='o_', id=1086732310805741709)
        return '\u200b'
