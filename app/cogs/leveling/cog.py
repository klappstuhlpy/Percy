...
class Leveling(Cog):
    ...
    @group("level", fallback="rank", description="Leveling purpose Commands.", guild_only=True, hybrid=True, bot_permissions=[discord.Permissions.attach_files, discord.Permissions.manage_roles])
