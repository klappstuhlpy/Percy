...
COMIC_API_URL=                       # self-hosted League of Comic Geeks API wrapper (comic subscriptions). Docker: http://comic-api:8070 (shared comic-net network); bare metal: http://127.0.0.1:8070
