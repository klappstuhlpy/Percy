...
```text
Phase 0  Provider migration   Groq → Ollama; remove Groq; AIService + OllamaClient + health probe
Phase 1  Config + flags       GuildConfig.AIFlags, per-channel overrides, dashboard "AI" tab
